        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.driver.distance-tiers.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               name="name" 
                                               value="{{ old('name') }}" 
                                               placeholder="Ví dụ: 5km đầu, 6-10km, >10km"
                                               required>
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="display_text">Text hiển thị <span class="text-danger">*</span></label>
                                        <input type="text" 
                                               class="form-control @error('display_text') is-invalid @enderror" 
                                               id="display_text" 
                                               name="display_text" 
                                               value="{{ old('display_text') }}" 
                                               placeholder="Ví dụ: 5km đầu, 6-10km, >10km, >30km"
                                               required>
                                        @error('display_text')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
