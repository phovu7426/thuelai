    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" name="distance_range" id="distance_range" class="form-control"
                   placeholder="Ví dụ: 0-5km, 5-10km..."
                   value="{{ $data['distance_range'] ?? old('distance_range') }}"
                   required>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" name="display_text" id="display_text" class="form-control"
                   placeholder="Ví dụ: Gần, Trung bình, Xa..."
                   value="{{ $data['display_text'] ?? old('display_text') }}"
                   required>
    ...
    <div class="col-md-12">
        <div class="mb-3">
            ...
            <textarea name="description" id="description" class="form-control" rows="3"
                      placeholder="Nhập mô tả khoảng cách...">{{ $data['description'] ?? old('description') }}</textarea>
