    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <select name="time_slot" id="time_slot" class="form-control" required>
                ...
                <option value="morning" {{ ($data['time_slot'] ?? old('time_slot')) == 'morning' ? 'selected' : '' }}>Sáng (6:00 - 12:00)</option>
                <option value="afternoon" {{ ($data['time_slot'] ?? old('time_slot')) == 'afternoon' ? 'selected' : '' }}>Chiều (12:00 - 18:00)</option>
                <option value="evening" {{ ($data['time_slot'] ?? old('time_slot')) == 'evening' ? 'selected' : '' }}>Tối (18:00 - 22:00)</option>
                <option value="night" {{ ($data['time_slot'] ?? old('time_slot')) == 'night' ? 'selected' : '' }}>Đêm (22:00 - 6:00)</option>
            </select>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <select name="price_type" id="price_type" class="form-control" required>
                ...
                <option value="fixed" {{ ($data['price_type'] ?? old('price_type')) == 'fixed' ? 'selected' : '' }}>Giá cố định</option>
                <option value="per_km" {{ ($data['price_type'] ?? old('price_type')) == 'per_km' ? 'selected' : '' }}>Giá theo km</option>
            </select>
    ...
    <div class="col-md-12">
        <div class="mb-3">
            ...
            <textarea name="description" id="description" class="form-control" rows="3"
                      placeholder="Nhập mô tả mức giá...">{{ $data['description'] ?? old('description') }}</textarea>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <select name="is_active" id="is_active" class="form-control">
                <option value="0" {{ ($data['is_active'] ?? old('is_active', 1)) == '0' ? 'selected' : '' }}>Tạm dừng</option>
                <option value="1" {{ ($data['is_active'] ?? old('is_active', 1)) == '1' ? 'selected' : '' }}>Hoạt động</option>
            </select>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="number" name="min_distance" id="min_distance" class="form-control"
                   ...
                   value="{{ $data['min_distance'] ?? old('min_distance', 0) }}"
                   min="0" step="0.1">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="number" name="max_distance" id="max_distance" class="form-control"
                   ...
                   value="{{ $data['max_distance'] ?? old('max_distance') }}"
                   min="0" step="0.1">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" name="time_icon" id="time_icon" class="form-control"
                   placeholder="Ví dụ: bi-sun, bi-moon..."
                   value="{{ $data['time_icon'] ?? old('time_icon') }}">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="color" name="time_color" id="time_color" class="form-control form-control-color"
                   value="{{ $data['time_color'] ?? old('time_color', '#007bff') }}"
                   title="Chọn màu cho khung giờ">
