    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <select name="type" id="type" class="form-control" required>
                ...
                <option value="distance" {{ (isset($data['type']) ? $data['type'] : old('type')) == 'distance' ? 'selected' : '' }}>Theo khoảng cách</option>
                <option value="time" {{ (isset($data['type']) ? $data['type'] : old('type')) == 'time' ? 'selected' : '' }}>Theo thời gian</option>
                <option value="special" {{ (isset($data['type']) ? $data['type'] : old('type')) == 'special' ? 'selected' : '' }}>Đặc biệt</option>
            </select>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="number" name="base_price" id="base_price" class="form-control"
                   ...
                   value="{{ isset($data['base_price']) ? $data['base_price'] : old('base_price') }}"
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <select name="unit" id="unit" class="form-control">
                ...
                <option value="km" {{ (isset($data['unit']) ? $data['unit'] : old('unit')) == 'km' ? 'selected' : '' }}>Kilometer</option>
                <option value="hour" {{ (isset($data['unit']) ? $data['unit'] : old('unit')) == 'hour' ? 'selected' : '' }}>Giờ</option>
                <option value="day" {{ (isset($data['unit']) ? $data['unit'] : old('unit')) == 'day' ? 'selected' : '' }}>Ngày</option>
            </select>
