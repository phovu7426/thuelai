                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('status') is-invalid @enderror" id="status"
                                            ...
                                            <option value="pending"
                                                {{ old('status', 'pending') == 'pending' ? 'selected' : '' }}>Chờ xử lý
                                            </option>
                                            <option value="processing"
                                                {{ old('status') == 'processing' ? 'selected' : '' }}>Đang xử lý</option>
                                            ...
                                            <div id="products-container">
                                                ...
                                                <div class="product-row mb-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number"
                                                                    ...
                                                                    name="products[0][quantity]" min="1"
                                                                    value="1" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="text-right mb-2">
                                                        <button type="button"
                                                            class="btn btn-sm btn-danger remove-product-row" disabled>
