...
@section('content')
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.stone.showrooms.index') }}" method="GET" class="mb-3">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="{{ route('admin.stone.showrooms.index') }}" class="btn btn-secondary">Reset</a>
                        </div>
                    </div>
                </form>
                        ...
                        <tbody>
                            @forelse($showrooms ?? [] as $showroom)
                                <tr>
                                    ...
                                    <td>
                                        @if ($showroom->image)
                                            <img src="{{ get_image_url($showroom->image) }}" alt="{{ $showroom->name }}"
                                    ...
                                    <td>
                                        <a href="{{ route('admin.stone.showrooms.edit', $showroom->id) }}"
                                            class="btn btn-info btn-sm">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form action="{{ route('admin.stone.showrooms.destroy', $showroom->id) }}"
