...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.stone.videos.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="video_url" id="video_url" class="form-control @error('video_url') is-invalid @enderror" value="{{ old('video_url') }}" placeholder="Nhập URL YouTube hoặc mã nhúng" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            @error('thumbnail')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="mt-2" id="thumbnail-preview"></div>
                        </div>
