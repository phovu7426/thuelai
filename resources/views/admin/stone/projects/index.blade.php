...
@section('content')
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.stone.projects.index') }}" method="GET" class="mb-3">
                    <div class="row">
                        <div class="col-md-3">
                            <input type="text" name="name" class="form-control" placeholder="Tên dự án"
                                value="{{ request('name') }}">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="{{ route('admin.stone.projects.index') }}" class="btn btn-secondary">Reset</a>
                        </div>
                    </div>
                </form>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($project->main_image)
                                            <img src="{{ get_image_url($project->main_image) }}" alt="{{ $project->name }}"
                                    ...
                                    <td>
                                        <a href="{{ route('admin.stone.projects.edit', $project->id) }}"
                                            class="btn btn-info btn-sm">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form action="{{ route('admin.stone.projects.destroy', $project->id) }}"
