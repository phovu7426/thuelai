                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.stone.surfaces.edit', $surface->id) }}" class="btn btn-info btn-sm">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <form action="{{ route('admin.stone.surfaces.destroy', $surface->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
