...
@section('content')
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.stone.applications.index') }}" method="GET" class="mb-3">
                    <div class="row">
                        <div class="col-md-3">
                            <input type="text" name="name" class="form-control" placeholder="Tên ứng dụng"
                                value="{{ request('name') }}">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="{{ route('admin.stone.applications.index') }}" class="btn btn-secondary">Reset</a>
                        </div>
                    </div>
                </form>
                        ...
                        <tbody>
                            @forelse($applications ?? [] as $application)
                                <tr>
                                    ...
                                    <td>
                                        @if ($application->image)
                                            <img src="{{ get_image_url($application->image) }}"
                                                alt="{{ $application->name }}" width="50" class="img-thumbnail">
                                        @else
                                    ...
                                    <td>
                                        <a href="{{ route('admin.stone.applications.edit', $application->id) }}"
                                            class="btn btn-info btn-sm">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form action="{{ route('admin.stone.applications.destroy', $application->id) }}"
