        ...
        <div class="col">
            <div class="card post-card h-100">
                ...
                <div class="position-relative">
                    @if($post->image)
                    <img src="{{ asset($post->image) }}" class="card-img-top post-image" alt="{{ $post->name }}">
                    @else
                ...
                <div class="card-body">
                    <h5 class="card-title">
                        <a href="{{ route('home.posts.show', $post->id) }}" class="text-decoration-none stretched-link">
                            {{ $post->name }}
                        </a>
                    </h5>
                ...
                <div class="card-footer py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('home.posts.show', $post->id) }}" class="btn btn-sm btn-outline-primary">
