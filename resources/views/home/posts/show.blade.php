            ...
            <div class="bg-white p-4 shadow-sm rounded-3 mb-4">
                ...
                @else
                    ...
                    <div class="card related-post-card mb-3">
                        ...
                        <img src="{{ asset($relatedPost->image) }}" class="card-img-top related-post-image" alt="{{ $relatedPost->name }}">
                        @else
                        <div class="bg-light related-post-image d-flex align-items-center justify-content-center">
                            <i class="fas fa-file-alt text-muted fa-2x"></i>
                        </div>
                        @endif
                        <div class="card-body">
                            <h6 class="card-title">
                                <a href="{{ route('home.posts.show', $relatedPost->id) }}" class="text-decoration-none text-dark stretched-link">
