...
<head>
    ...
    <title>Yêu cầu đặt lại mật khẩu - ThuêLai.vn</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        <p>Xin chào,</p>
        <p>Chúng tôi nhận được yêu cầu đặt lại mật khẩu cho tài khoản của bạn tại <strong>ThuêLai.vn</strong>. Vui lòng sử dụng mã OTP dưới đây để tiếp tục:</p>
