                                    ...
                                    <tbody>
                                        @foreach ($cartItems as $item)
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        @if (!empty($item->main_image))
                                                            <img src="{{ get_image_url($item->main_image) }}"
                                                        ...
                                                        <div>
                                                            ...
                                                            <a href="{{ route('stone.products.show', $item->id) }}"
                                                ...
                                                <td>
                                                    <form action="{{ route('stone.cart.update') }}" method="POST"
                                                        class="d-flex">
                                                        @csrf
                                                ...
                                                <td class="text-right">{{ number_format($item->price * $item->quantity) }}
                                                    đ</td>
