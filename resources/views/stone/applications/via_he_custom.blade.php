...
@section('page_title', 'Ứng dụng Via hè')
            ...
            <div class="col-md-8">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="content">
                            <p>Đá via hè là loại đá được sử dụng để lát vỉa hè, lối đi trong công viên, khu đô thị, khu nghỉ
                                dưỡng...</p>
                            <p>Đá via hè thường được làm từ đá granite, đá bazan hoặc đá xanh. Đá via hè có nhiều kích thước
                                và màu sắc khác nhau.</p>
