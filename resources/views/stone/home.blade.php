...
<div class="swiper hero-slider">
    <div class="swiper-wrapper">
        <div class="swiper-slide hero-slide" style="background-image: url('{{ asset('images/default/default_image.png') }}');">
            <div class="hero-content">
                <h1>Đá tự nhiên cao cấp</h1>
                <p>Chuyên cung cấp và thi công đá tự nhiên cao cấp với chất lượng tốt nhất, mẫu mã đa dạng và giá cả cạnh tranh.</p>
        ...
        <div class="swiper-slide hero-slide" style="background-image: url('{{ asset('images/default/default_image.png') }}');">
            <div class="hero-content">
                ...
                <p>Đội ngũ thợ lành nghề với nhiều năm kinh nghiệm, đảm bảo thi công đúng kỹ thuật, chính xác và thẩm mỹ cao.</p>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <p class="lead mb-4">Đơn vị hàng đầu trong lĩnh vực cung cấp và thi công đá tự nhiên cao cấp tại Việt Nam.</p>
                <p>Với hơn 10 năm kinh nghiệm, chúng tôi tự hào mang đến cho khách hàng những sản phẩm đá tự nhiên chất lượng cao, mẫu mã đa dạng với giá cả cạnh tranh nhất thị trường.</p>
                <div class="row mt-4">
                ...
                @foreach($applications as $application)
                    <div class="col-lg-6 col-md-6 mb-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="row g-0">
                                <div class="col-md-5">
                                    <img src="{{ asset('images/default/default_image.png') }}" class="img-fluid h-100" style="object-fit: cover;" alt="{{ $application->name }}">
                                </div>
                                <div class="col-md-7">
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $application->name }}</h5>
                                        <p class="card-text">{{ \Illuminate\Support\Str::limit($application->description ?? 'Không có mô tả', 100) }}</p>
                                        <a href="{{ url('/stone/applications/' . $application->slug) }}" class="btn btn-sm btn-outline-primary">Tìm hiểu thêm</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                @foreach($featuredProjects as $project)
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100 border-0 shadow-sm overflow-hidden">
                            <img src="{{ asset('images/default/default_image.png') }}" class="card-img-top" alt="{{ $project->name }}" style="height: 250px; object-fit: cover;">
                            <div class="card-body">
                                <h5 class="card-title">{{ $project->name }}</h5>
                                <p class="card-text">{{ \Illuminate\Support\Str::limit($project->description ?? 'Không có mô tả', 100) }}</p>
                                <a href="{{ url('/stone/projects/' . $project->slug) }}" class="btn btn-sm btn-outline-primary">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
                @endforeach
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <p class="mb-2"><i class="fas fa-phone text-primary me-2"></i> {{ $showroom->phone }}</p>
                                <p class="mb-3"><i class="fas fa-envelope text-primary me-2"></i> {{ $showroom->email }}</p>
                                <a href="{{ url('/stone/showrooms/' . $showroom->slug) }}" class="btn btn-sm btn-outline-primary">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
                @endforeach
...
<!-- CTA Section -->
<section class="section bg-dark text-white" style="background-image: url('{{ asset('images/default/default_image.png') }}'); background-size: cover; background-position: center; position: relative;">
