    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                @if($product->category)
                    <li class="breadcrumb-item"><a href="{{ url('/stone/products/category/' . $product->category->slug) }}">{{ $product->category->name }}</a></li>
                @endif
                        ...
                        @if($product->category)
                            <div class="product-meta-item">
                                ...
                                <div class="product-meta-value">
                                    <a href="{{ url('/stone/products/category/' . $product->category->slug) }}">{{ $product->category->name }}</a>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class="mb-2"><i class="fas fa-check-circle text-primary me-2"></i> Chất lượng cao cấp</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-primary me-2"></i> Độ bền cao</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-primary me-2"></i> Dễ dàng vệ sinh</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-primary me-2"></i> Màu sắc đẹp, tự nhiên</li>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="mb-4">
                            ...
                            <p>Sản phẩm đá {{ $product->name }} thích hợp cho các ứng dụng nội thất như mặt bàn bếp, mặt bàn phòng khách, bậc cầu thang, bậc cửa, mặt lavabo...</p>
                        </div>
                        
                        <div class="mb-4">
                            <h6><i class="fas fa-building text-primary me-2"></i> Ứng dụng trong ngoại thất</h6>
                            <p>Ngoài ra, sản phẩm còn được sử dụng trong các công trình ngoại thất như ốp mặt tiền, lát sân vườn, bậc thềm, đường dạo...</p>
                        </div>
                        
                        <div>
                            <h6><i class="fas fa-hotel text-primary me-2"></i> Ứng dụng trong công trình công cộng</h6>
                            <p>Đá {{ $product->name }} cũng được sử dụng rộng rãi trong các công trình công cộng như khách sạn, trung tâm thương mại, văn phòng...</p>
                        </div>
                    </div>
                        ...
                        <div class="product-card card h-100">
                            <div class="position-relative">
                                ...
                                @if($relatedProduct->discount_percent > 0)
                                    <span class="position-absolute top-0 end-0 bg-danger text-white px-2 py-1 m-2 rounded-pill">-{{ $relatedProduct->discount_percent }}%</span>
                                @endif
                            </div>
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <div>
                                        @if($relatedProduct->discount_price)
                                            <span class="text-decoration-line-through text-muted me-2">{{ number_format($relatedProduct->price) }}đ</span>
                                            <span class="fw-bold text-danger">{{ number_format($relatedProduct->discount_price) }}đ</span>
                                        @else
                                            <span class="fw-bold">{{ number_format($relatedProduct->price) }}đ</span>
                                        @endif
                                    </div>
                                    <a href="{{ url('/stone/products/' . $relatedProduct->slug) }}" class="btn btn-sm btn-outline-primary">Chi tiết</a>
                                </div>
                            </div>
                        </div>
                    </div>
