                    ...
                    @if(count($relatedVideos) > 0)
                        <div class="list-group">
                            @foreach($relatedVideos as $relatedVideo)
                                <a href="{{ route('stone.videos.show', $relatedVideo->slug) }}" class="list-group-item list-group-item-action">
                                    <div class="row g-0">
                                        <div class="col-4">
                                            <div class="position-relative">
                                                <img src="{{ get_image_url($relatedVideo->thumbnail) }}" class="img-fluid" alt="{{ $relatedVideo->title }}">
